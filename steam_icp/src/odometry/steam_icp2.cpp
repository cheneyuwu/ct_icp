...
SteamOdometry2::SteamOdometry2(const Options &options) : Odometry(options), options_(options) {
...
auto SteamOdometry2::registerFrame(const std::vector<Point3D> &const_frame) -> RegistrationSummary {
...
void SteamOdometry2::updateMap(int index_frame, int update_frame) {
